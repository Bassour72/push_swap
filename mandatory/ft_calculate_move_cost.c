...
// 	size_b = ft_stack_size(stack_b);
// 	pos_b = ft_get_position(stack_b, node_b);
// 	target_pos_a = find_target_position(stack_a, node_b->index);
// 	calculate_moves_to_top(target_pos_a, size_a, &ra, &rra);
// 	calculate_moves_to_top(pos_b, size_b, &rb, &rrb);
// 	determine_best_rotation(ra, rra, rb, rrb, cost);
// }
