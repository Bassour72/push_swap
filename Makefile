...
SRCS_BONUS = \
	...
	$(BONUS_DIR)/ft_is_command_valid_bonus.c \
	$(BONUS_DIR)/ft_validate_command_bonus.c \
	$(BONUS_DIR)/ft_addnode__bonus.c \
	$(BONUS_DIR)/ft_lstadd_back_bonus.c \
	$(BONUS_DIR)/ft_read_and_validate_command_bonus.c \
	$(BONUS_DIR)/ft_parse_commands_bonus.c \
	$(BONUS_DIR)/ft_preccess_command_bonus.c \
